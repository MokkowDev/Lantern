...
class ConfigCommand : Command("config", arrayOf("localsetting", "localsettings", "localconfig", "localautosettings")) {
    /**
        ...
        return when (args.size) {
            ...
            2 -> {
                when (args[0].toLowerCase()) {
                    "delete", "load" -> {
                        val settings = this.getConfigs() ?: return emptyList()
    ...
    private fun getConfigs(): Array<File>? = LiquidBounce.fileManager.settingsDir.listFiles()
}